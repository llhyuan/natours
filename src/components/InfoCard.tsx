      ...
      >
        ...
        <div className="flex-1 flex justify-center items-center">
          <Link
            href={tourDetail}
            className={
              "w-fit py-4 px-8 mx-auto bg-gradient-to-br from-[#7dd56f]/90 to-[#28b487]/95 text-zinc-100 rounded-full tracking-wide transition-all duration-100 ease-in hover:shadow-[0_0.4rem_0.8rem_rgba(0,0,0,0.2)] hover:translate-y-[-5px]"
            }
          >
            DETAILS
          </Link>
